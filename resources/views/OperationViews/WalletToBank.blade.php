            ...
            <div class="col-lg-12 ">
                <div class="card">
                    ...
                    <div class="card-body p-4 mb-4">
                        <form id="myForm" action="{{ route('WalletToBank') }}" method="POST">
                            @csrf
                            <ul class="wizard-nav">
                                                ...
                                                <div class="mb-3">
                                                    <div class="mb-3">
                                                        <input type="text" class="form-control" readonly
                                                            id="formrow-password-input" value="{{ $lastName }}">
                                                    </div>
                                                </div>
                                            </div><!-- end col -->
                                            <div class="col-md-6">
                            ...
                            <div class="wizard-tab">
                                ...
                                <div class="row d-flex justify-content-center">
                                    <div class="col-lg-6 ">
                                        ...
                                        <div class="mb-1">
                                            <label for="basicpill-vatno-input" class="form-label">Montant a
                                                renverser</label>
                                            <div class="d-flex align-items-center flex-direction-row gap-3">
