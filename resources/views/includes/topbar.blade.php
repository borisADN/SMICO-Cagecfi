    ...
    <div class="navbar-header">
        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="index.html" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="{{ asset('assets/images/personnalisation/_logo.png') }}" alt="" height="26"> <span
                ...
                <a href="index.html" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{ asset('assets/images/personnalisation/_logo.png') }}" alt="" height="26">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('assets/images/personnalisation/_logo.png') }}" alt="" height="26"> <span
                            class="logo-txt">Cagecfi</span>
                    </span>
                </a>
            </div>
                        ...
                        <ul class="navbar-nav">
                                                    ...
                                                    <div class="row g-0">
                                                        <div class="col-lg-5">
                                                            <div>
                                                                ...
                                                                <a href="ui-modals.html" class="dropdown-item"
                                                                data-key="t-modals">simulation Tableau D'ammortissement</a>
                                                        ...
                                                        <div class="col-lg-5">
                                                            <div>
                                                                ...
                                                                <a href="ui-utilities.html" class="dropdown-item"
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-pages">
                                    ...
                                    <a href="{{ route('form1') }}" class="dropdown-item"
                                        data-key="t-gallery">Transert entre mes comptes</a>

                                    <a href="apps-gallery.html" class="dropdown-item"
                                        data-key="t-gallery">Virement vers autres comptes CDC</a>

                                    <a href="apps-gallery.html" class="dropdown-item"
                                        data-key="t-gallery">Depot CDC via mobile money</a>

                                    <a href="apps-gallery.html" class="dropdown-item"
                                        data-key="t-gallery">Retrait CDC via mobile money</a>
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-components">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-charts">
                                            <a href="charts-line.html" class="dropdown-item"
                                                data-key="t-line">Line</a>
                                            <a href="charts-area.html" class="dropdown-item"
                            ...
                            {{-- <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-more">
                                    ...
                                    <a href="layout-vertical.html" class="dropdown-item"
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block language-switch">
                <button type="button" class="btn header-item noti-icon" data-bs-toggle="dropdown"
                    aria-haspopup="true" aria-expanded="false">
                    <img id="header-lang-img" src="https://themesdesign.in/vuesy/layouts/assets/images/flags/us.jpg"
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="eng">
                        <img src="https://themesdesign.in/vuesy/layouts/assets/images/flags/us.jpg" alt="user-image"
                            class="me-2" height="12"> <span class="align-middle">English</span>
                    </a>
                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="sp">
                        <img src="https://themesdesign.in/vuesy/layouts/assets/images/flags/spain.jpg"
                            alt="user-image" class="me-2" height="12"> <span
                            class="align-middle">Spanish</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="gr">
                        <img src="https://themesdesign.in/vuesy/layouts/assets/images/flags/germany.jpg"
                            alt="user-image" class="me-2" height="12"> <span class="align-middle">German</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="it">
                        <img src="https://themesdesign.in/vuesy/layouts/assets/images/flags/italy.jpg"
                            alt="user-image" class="me-2" height="12"> <span
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="ru">
                        <img src="https://themesdesign.in/vuesy/layouts/assets/images/flags/russia.jpg"
                            alt="user-image" class="me-2" height="12"> <span
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="text-muted">
                                        <p class="mb-1 font-size-13">Your task changed an issue from "In
                                            Progress" to <span
                                                class="badgebg-success-subtle text-success">Review</span></p>
