<div id="custom-spinner-alert" style="display: none;">
    <div class="custom-spinner-box">
        <div class="spinner-content">
            <!-- Nouveau spinner SVG -->
            <svg class="pl" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
                <defs>
            ...
            <p id="custom-spinner-text">Chargement en cours...</p>
        </div>
    </div>
</div>