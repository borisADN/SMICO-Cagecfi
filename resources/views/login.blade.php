                                    ...
                                    <div class="px-3 py-3">
                                        ...
                                        <form class="mt-4 pt-2" action="{{ route('login') }}" method="post">
                                            ...
                                            <div class="form-check form-check-primary font-size-16 py-1">
                                                ...
                                                <label class="form-check-label font-size-14" for="remember-check" data-key="t-login6">
                                                    Rester connecté
                                                </label>
                                            </div>
                                            ...
                                            <div class="mt-4 pt-3 text-center">
                                                <a href="auth-resetpassword-basic.html" class="text-muted text-decoration-underline font-size-14" data-key="t-login5">Mot de Passe Oublié?</a>
                                                <div class="float-end">
                                                </div>
